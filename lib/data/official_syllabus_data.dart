...
class OfficialSyllabusData {
  ...
  static const List<AppscSyllabusSection> appscSections = [
    ...
    AppscSyllabusSection(
      ...
      targetCadres: 'Assistant Engineer (Civil, Electrical, Mechanical) in PWD, RWD, PHE, WRD, Power',
    ...
    AppscSyllabusSection(
      examName: 'Arunachal Engineering Service (AESE - AE)',
      targetCadres: 'Assistant Engineer (Civil/EE/ME)',
      stage: 'Stage 1: Recruitment Exam (Written)',
      paperName: 'Paper-II: General Studies',
      marks: 100,
    ...
    AppscSyllabusSection(
      ...
      targetCadres: 'Assistant Engineer (Civil/EE/ME)',
      stage: 'Stage 1: Recruitment Exam (Written)',
      paperName: 'Paper-III: Technical Engineering Paper-I',
      marks: 150,
      duration: '3 Hours (Objective/Descriptive)',
      negativeMarking: 'Pass mark: 33%',
      primaryCurriculum:
          'Degree standard (B.Tech/BE): For Civil: Structural Analysis, Building Materials & Construction, Design of RC & Steel Structures, Geotechnical / Foundation Engineering, Fluid Mechanics, Hydraulics.',
      arunachalComponent: 'Regional engineering practices (Hilly terrain construction, landslide stabilization).',
    ...
    AppscSyllabusSection(
      ...
      targetCadres: 'Assistant Engineer (Civil/EE/ME)',
      stage: 'Stage 1: Recruitment Exam (Written)',
      paperName: 'Paper-IV: Technical Engineering Paper-II',
      marks: 150,
      duration: '3 Hours (Objective/Descriptive)',
      negativeMarking: 'Pass mark: 33%',
      primaryCurriculum:
          'For Civil: Hydrology & Water Resources, Irrigation Engineering, Environmental Engineering (Water supply, sewerage), Transportation Engineering (Highway planning, hill roads), Surveying & Photogrammetry, Project Management.',
      arunachalComponent: 'Hill road design (IRC guidelines), water harvesting in hilly belts.',
    ...
    AppscSyllabusSection(
      ...
      targetCadres: 'Junior Engineer (Civil, Electrical, Mechanical)',
      stage: 'Stage 1: Written Examination',
      paperName: 'Paper-I: General English & General Knowledge',
      marks: 100,
    ...
    AppscSyllabusSection(
      examName: 'Junior Engineer (JE) Common Exam',
      targetCadres: 'Junior Engineer (Civil/EE/ME)',
      stage: 'Stage 1: Written Examination',
      paperName: 'Paper-II: Technical Engineering Domain',
      marks: 200,
      duration: '3 Hours (Objective/Conventional)',
      negativeMarking: 'Technical Core (Min 33%)',
      primaryCurriculum:
          'Diploma Standard curriculum: For Civil: Surveying, Estimating & Costing, Building Materials, Strength of Materials, Concrete Technology, RCC & Steel Design, Hydraulics, Soil Mechanics, Highway Engineering, Public Health Engineering.',
      arunachalComponent: 'Standard mountain engineering practices, hill road maintenance.',
    ...
    AppscSyllabusSection(
      ...
      arunachalComponent: 'Arunachal terrain awareness.',
